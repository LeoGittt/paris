      ...
      <section id="contacto" className="py-24 md:py-32 bg-[#040f1c] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <div className="text-center mb-14">
            ...
            <h2 className="font-black text-white uppercase leading-none text-5xl md:text-7xl mb-4">CONTACTO</h2>
            <p className="text-white/50 text-base md:text-lg max-w-md mx-auto font-medium">¿Tenés dudas sobre el prode? Contactanos a través de Grupo Paris.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl mx-auto">
            {[
              ...
              <div
                key={item.label}
                className="flex flex-col items-center text-center gap-4 bg-[#0b2440] border border-white/8 rounded-2xl px-6 py-8"
              >
                <div
                ...
                <div>
                  <p className="text-white/30 text-[10px] font-black uppercase tracking-[0.25em] mb-1">{item.label}</p>
                  <p className="text-white font-bold text-sm">Grupo Paris</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className="bg-[#020b15] border-t border-white/6">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              <p className="text-white/60 text-[11px] font-black uppercase tracking-[0.3em] mb-5">Grupo Paris</p>
              <p className="text-white/35 text-sm leading-relaxed font-medium">Concesionario oficial Chevrolet.</p>
            </div>
          </div>
