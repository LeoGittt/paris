...
export function LandingClient({ rankingRows, prizes, upcomingMatches }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#06192c] overflow-x-hidden" style={{ fontFamily: "'ChevySans', sans-serif" }}>
        ...
        <div className="absolute inset-0 flex flex-col justify-center pb-0 px-5 md:justify-center md:items-center md:pb-0 md:px-10 pt-20">
          <div className="w-full md:max-w-3xl md:text-center">
            ...
            <div className="mb-5 md:mb-8">
              <div className="inline-flex items-center gap-2.5 bg-emerald-500/10 border border-emerald-500/25 rounded-2xl px-4 py-2.5">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse shrink-0" />
                <span className="text-emerald-400 font-black uppercase tracking-[0.2em] text-[11px] md:text-[12px]">El Mundial ya comenzó</span>
              </div>
            </div>
      ...
      {/* BANNER */}
      <div className="bg-[#06192c]">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-6 md:py-8">
          <Image src="/banner-prode.png" alt="Prode Grupo Paris 2026 — Viví el mundial. Ganá premios." width={1200} height={200} className="w-full h-auto object-cover rounded-xl" quality={95} />
        </div>
      </div>
