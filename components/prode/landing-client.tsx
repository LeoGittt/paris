        ...
        <div className="absolute inset-0 flex flex-col justify-center pb-0 px-5 md:justify-center md:items-center md:pb-0 md:px-10 pt-20">
          <div className="w-full md:max-w-3xl md:text-center">
            ...
            <p className="hidden md:block text-white/65 text-lg leading-relaxed mb-7 font-medium">
              Predecí los resultados, sumá puntos y ganá premios increíbles con Chevrolet Grupo Paris.
            </p>
      ...
      <section id="prode" className="py-24 md:py-32 bg-[#040f1c]">
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
            ...
            <p className="text-white/45 text-sm leading-relaxed max-w-xs md:text-right font-medium">Completá tus predicciones antes del pitido inicial de cada partido.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            {upcomingMatches.length > 0 ? upcomingMatches.map(match => (
              ...
              <div className="col-span-3 text-center py-10">
                <p className="text-white/25 text-base font-medium">Los partidos se publicarán pronto</p>
              </div>
            )}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            <div>
              ...
              <p className="text-white/35 text-sm leading-relaxed font-medium mb-6">El prode oficial del Mundial 2026 de Chevrolet Grupo Paris.</p>
              ...
              <div className="flex items-center gap-3">
                <a href="https://www.instagram.com/parischevroletsanjuan/" target="_blank" rel="noopener noreferrer"
                  className="group w-9 h-9 rounded-xl flex items-center justify-center border border-white/10 bg-white/4 hover:bg-[#E1306C]/15 hover:border-[#E1306C]/40 transition-all" aria-label="Instagram">
                  <svg className="w-4 h-4 text-white/40 group-hover:text-[#E1306C] transition-colors" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                </a>
                <a href="https://wa.me/5492645000000" target="_blank" rel="noopener noreferrer"
                  className="group w-9 h-9 rounded-xl flex items-center justify-center border border-white/10 bg-white/4 hover:bg-[#25D366]/15 hover:border-[#25D366]/40 transition-all" aria-label="WhatsApp">
                ...
                <a href="https://www.facebook.com/GrupoParis" target="_blank" rel="noopener noreferrer"
                  className="group w-9 h-9 rounded-xl flex items-center justify-center border border-white/10 bg-white/4 hover:bg-[#1877F2]/15 hover:border-[#1877F2]/40 transition-all" aria-label="Facebook">
            ...
            <div>
              ...
              <a href="https://share.google/5qZ3mlDd847Gr1pqg" target="_blank" rel="noopener noreferrer"
                ...
                <iframe src="https://maps.google.com/maps?q=Chevrolet+Paris+San+Juan+Argentina&output=embed&z=15"
                  width="100%" height="100%"
                  style={{ border: 0, filter: "invert(90%) hue-rotate(180deg)", pointerEvents: "none" }}
                  allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Chevrolet Grupo Paris — San Juan" />
                <div className="absolute inset-0 flex items-end p-3 opacity-0 group-hover:opacity-100 transition-opacity">
                  <span className="bg-[#020b15]/80 backdrop-blur-sm text-white text-[10px] font-bold px-2.5 py-1 rounded-lg">Ver en Google Maps →</span>
                </div>
              </a>
